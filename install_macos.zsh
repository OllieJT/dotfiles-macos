...
defaults write NSGlobalDomain InitialKeyRepeat -int 45
...
tell application "Terminal"
	...
	do shell script "open '$HOME/.dotfiles/Dracula/Dracula.terminal'"
...
open "${HOME}/.dotfiles/Dracula/Dracula.itermcolors"

# Don’t display the annoying prompt when quitting iTerm
defaults write com.googlecode.iterm2 PromptOnQuit -bool false

# Sync custom settings to file
defaults write com.googlecode.iterm2 LoadPrefsFromCustomFolder -bool true
defaults write com.googlecode.iterm2 PrefsCustomFolder -string "$HOME/.dotfiles/iterm2/com.googlecode.iterm2"
